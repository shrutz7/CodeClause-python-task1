...
if __name__ == "__main__" :
	...
	enterTask = Label(gui, text = "Enter Your Task", bg = "peach puff")
	...
	Submit = Button(gui, text = "Submit", fg = "Black", bg = "snow", command = insertTask)
	...
	taskNumber = Label(gui, text = "Delete Task Number", bg = "snow")
	...
	# when user press the button, the command or 
	# function affiliated to that button is executed .
	delete = Button(gui, text = "Delete", fg = "Black", bg = "snow", command = delete)

	# create a Exit Button and place into the root window
	# when user press the button, the command or 
	# function affiliated to that button is executed .
	Exit = Button(gui, text = "Exit", fg = "Black", bg = "snow", command = exit)
